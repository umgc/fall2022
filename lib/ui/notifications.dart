...
MailPiece clickedMailPiece =
    new MailPiece("", "", time, "", "", "", "", null, null, null);
                ...
                Semantics(
                  ...
                  child: SizedBox(
                    child: Text(
                      'Date',
                      style: TextStyle(
                          color: Color.fromRGBO(51, 51, 102, 1), fontSize: 18),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                child: Text(
                                  'Go to Message',
                                  semanticsLabel: "Go to " +
                                      item.subscriptionKeyword +
                                      " Message",
                                  style: TextStyle(color: Colors.white),
                                ),
                                style: ButtonStyle(
                                ...
                                onPressed: () async {
                                  Navigator.pushNamed(
                                      context, '/mail_piece_view',
                                      arguments: new MailPieceViewArguments(
                                          await getMailPiece(
                                              item.mailPieceId)));
                                },
                              ),
                              ...
                              ElevatedButton(
                                child: Text(
                                  'Clear',
                                  semanticsLabel:
                                      "Clear " + item.subscriptionKeyword,
                                  style: TextStyle(color: Colors.white),
                                ),
                                style: ButtonStyle(
                                  backgroundColor:
                                ...
                                onPressed: () {
                                  removeNotification(item.mailPieceId,
                                      item.subscriptionKeyword);
                                },
                              )
                            ],
                  ...
                  child: OutlinedButton(
                    ...
                    onPressed: () {
                      ...
                      FirebaseAnalytics.instance.logEvent(
                          ...
                          parameters: {'Add_Keyword': _keywordController.text});
                      _keywordController.clear();
                    },
                  ),
                )
